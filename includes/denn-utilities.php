<?php
	 ...
	 * The main one that is used in denn is denn_utilities::add_slug_to_body_class(), this will add the page or post slug to the body class
	 *
	 */
	 
	 class denn_utilities {
    	 ...
    	 * e.g. denn_utilities::get_page_id_from_path('about/terms-and-conditions');
    	 *
    	 * @param 	string 
    	 * @return 	integer
    	 * @author Denn
